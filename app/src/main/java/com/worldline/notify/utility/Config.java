package com.worldline.notify.utility;

public class Config {
    public static final String SERVER_HOST = "http://125.17.111.14:8080/wlnotify/";

    public static final String LOGIN_URL = SERVER_HOST + "Login.php";
